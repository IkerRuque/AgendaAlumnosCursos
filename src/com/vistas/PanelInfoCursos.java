 ...
 * @author Iker Ruiz
 */
public class PanelInfoCursos extends javax.swing.JPanel {

    /**
     * Creates new form PanelTrabAlumnos
     */
    public PanelInfoCursos(GestionInscripciones gesInsc) {
        initComponents();
    ...
    private void initComponents() {
        ...
        eticTitulo.setText("Listado de los alumnos del curso");
        ...
        cajaBusqueda.setForeground(new java.awt.Color(153, 153, 153));
        cajaBusqueda.setText("Escriba el nombre del curso");
        ...
        tablaAlumnos.setBackground(new java.awt.Color(51, 51, 51));
        tablaAlumnos.setFont(new java.awt.Font("Trebuchet MS", 0, 12)); // NOI18N
        ...
        tablaAlumnos.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nombre Alumno", "Correo Electronico", "Telefono", "Calificacion", "Fecha Matricuacion", "Fecha Calificacion"
            }
        ));
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addComponent(cajaBusqueda, javax.swing.GroupLayout.PREFERRED_SIZE, 717, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(79, 79, 79)
     ...
     * @param nomCurso
     */
    public void refrescar(String nomCurso) {
        ResultSet rs;
        DefaultTableModel tabAlu = (DefaultTableModel) tablaAlumnos.getModel();
        tabAlu.setRowCount(0);

        try {
            rs = gesInsc.mostrarAlumnosCurso(nomCurso);

            while (rs.next()) {
                String[] fila = {rs.getString("alumnos.nombre") + " " + rs.getString("alumnos.apellido"), rs.getString("alumnos.correo_electronico"), rs.getString("alumnos.telefono"), rs.getString("inscripciones.calificacion"), rs.getString("inscripciones.fecha_matriculacion"), rs.getString("inscripciones.fecha_calificacion")};
                tabAlu.addRow(fila);
            }
     ...
     * caja de texto en la que aparece el nombre del curso para consultar en la
     * base de datos. Cada vez que se utiliza, refresca la tabla.
     *
     * @param evt
     */
    private void textBtBuscarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_textBtBuscarMouseClicked
        String nomCurso = cajaBusqueda.getText().trim();
        try {
    ...
    private void cajaBusquedaMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_cajaBusquedaMousePressed
        if (cajaBusqueda.getText().equals("Escriba el nombre del curso")) {
