...
public class PanelListadoCursos extends javax.swing.JPanel {
     ...
     */
    public PanelListadoCursos(GestionCursos gesCurso) {
        initComponents();
    ...
    private void initComponents() {
        ...
        eticTitulo.setText("LISTADO DE CURSOS");
    ...
    /**
     * Metodo que refresca cada vez que se abre la clase, la lista de cursos
     * existentes en la base de datos
     */
    public void refrescar() {
        ArrayList<String> lista = new ArrayList();
        lista = gesCurso.mostrarTodo();
        int i = 0;

        for (String e : lista) {
            panelListado.append("Curso " + i + "\t" + e + "\n");
            i++;
    ...
    /**
     * Metodo que guarda a modo de fichero de texto, la lista de cursos expuesta
    ...
    private void textBtEntrarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_textBtEntrarMouseClicked
        ...
        fichero.escribir(panelListado.getText(), "listadoCursos.txt");
